...
import GloblFilters from "./GloblFilters";
            ...
            {result.length > 0 ? (
              result.map((item: any, index: number) => (
                <Link
                  ...
                  className="flex w-full cursor-pointer items-start gap-3 px-5 py-3 hover:bg-light-700/50 dark:hover:bg-dark-500/50"
                >
                  <Image
